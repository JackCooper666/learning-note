...
## depth-first search with binary search tree
...
bool res = false;
long long up_bar = LLONG_MAX;
long long down_bar = LLONG_MIN;
res = BSTcheck(root, down_bar, up_bar);
return res;
}
bool BSTcheck(TreeNode* root, long long down_bar, long long up_bar){
if(root == nullptr) return true;
int value = root->val;
bool l = BSTcheck(root->left, down_bar, value);
bool r = BSTcheck(root->right, value, up_bar);
if(l && r){
if(down_bar < value && value < up_bar){
return true;
}
else{
return false;
